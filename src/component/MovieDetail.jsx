...
// Import tất cả các mảng dữ liệu phim của bạn
// Đảm bảo đường dẫn này đúng với vị trí file data.js của bạn
import { 
  dataPhimMoiSapChieu, 
  dataPhimDeCu, 
  dataPhimLe, 
...
function MovieDetail() {
  // Lấy giá trị của tham số 'idphim' từ URL
  // idphim giờ đây đã là dạng chuỗi (slug) ở định dạng camelCase
