...
export default function SectionMovie() {
  ...
  const containerStyle = {
    ...
    // padding: "2rem 2rem", // Tương đương p-4
    marginTop: "50px",
    display: "flex",
    alignItems: "center",
  ...
  const cardStyle = {
    ...
    boxShadow:
      "0 10px 15px -3px rgba(0, 0, 0, 0.1), 0 4px 6px -2px rgba(0, 0, 0, 0.05)", // Tương đương shadow-lg
    overflow: "hidden",
  ...
  const buttonHoverStyle = {
    // Style cho hover, sẽ được áp dụng qua JS events
  ...
  if (isLargeScreen) {
    ...
    Object.assign(imageWrapperStyle, { width: "100%", padding: "" }); // md:w-1/2 md:p-6
  ...
  if (!movie) {
    return (
      <div style={notFoundContainerStyle}>
        <h2 style={notFoundTextStyle}>Không tìm thấy phim này! 😢</h2>
      </div>
    );
  }
      ...
      <div style={cardStyle}>
        <div style={imageWrapperStyle}>
          <img
            src={
              movie.imgbig ||
              "https://placehold.co/400x600/1a202c/e2e8f0?text=No+Image"
            }
            alt={movie.title}
            style={imageStyle}
            onError={(e) => {
              ...
              e.target.src =
                "https://placehold.co/400x600/1a202c/e2e8f0?text=Image+Error";
            }}
          />
        </div>
        <div style={infoWrapperStyle}>
          ...
          <p style={descriptionStyle}>
            Đây là phần mô tả chi tiết của phim. Bạn có thể thêm nhiều thông tin
            khác về bộ phim ở đây như đạo diễn, diễn viên, thể loại, tóm tắt nội
            dung, v.v. Để làm được điều này, bạn cần bổ sung các trường dữ liệu
            tương ứng vào đối tượng phim trong file `data.js` của mình.
          </p>
